...
test('Second Test Name - This One Will Timeout', async ({ page }) => {
  // visit the site
  ...
  await page.fill('#react-select-22222222-input', 'fav_user');
...
test('Third Test Name - This One Will Fail', async ({ page }) => {
  // visit the site
  await page.goto('https://bstackdemo.com/');
  ...
  await page.fill('#react-select-2-input', user);
  await page.press('#react-select-2-input', 'Enter');
  await page.fill('#react-select-3-input', 'testingisfun99');
  await page.press('#react-select-3-input', 'Enter');
  await page.click('#login-btn');
